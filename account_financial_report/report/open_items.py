...
class OpenItemsReport(models.AbstractModel):
    ...
    def _get_data(
        ...
        if date_at_object < date.today():
            accounts_partial_reconcile, debit_accounts_partial_amount, credit_accounts_partial_amount = self._get_account_partial_reconciled(
                move_lines_data, date_at_object
            )
    ...
    def _get_report_values(self, docids, data):
        ...
        move_lines_data, partners_data, journals_data, accounts_data, open_items_move_lines_data = self._get_data(
            account_ids, partner_ids, date_at_object, target_move, company_id, date_from
        )
